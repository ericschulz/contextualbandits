#Bayesian Mean
bmei<-read.csv("/home/hanshalbe/Desktop/cmab/data3/BayesMeanExpectedImp.csv")
bmpi<-read.csv("/home/hanshalbe/Desktop/cmab/data3/BayesMeanProbOfImp.csv")
bmth<-read.csv("/home/hanshalbe/Desktop/cmab/data3/BayesMeanThompon.csv")
bmuc<-read.csv("/home/hanshalbe/Desktop/cmab/data3/BayesMeanUCB.csv")

#Kalman Filter
kfei<-read.csv("/home/hanshalbe/Desktop/cmab/data3/KalmanExpectedImp.csv")
kfpi<-read.csv("/home/hanshalbe/Desktop/cmab/data3/KalmanProbOfImp.csv")
kfth<-read.csv("/home/hanshalbe/Desktop/cmab/data3/KalmanThompon.csv")
kfuc<-read.csv("/home/hanshalbe/Desktop/cmab/data3/KalmanUCB.csv")
...
for (folks in 1:48){
  ...
  dat<-read.csv(paste0("/home/hanshalbe/Desktop/cmab/data2/lin/p",partic, "lin.csv"))
...
#Ornstein Uhlenbeck
ouei<-read.csv("/home/hanshalbe/Desktop/cmab/data3/OruExpectedImp.csv")
oupi<-read.csv("/home/hanshalbe/Desktop/cmab/data3/OruProbOfImp.csv")
outh<-read.csv("/home/hanshalbe/Desktop/cmab/data3/OruThompon.csv")
ouuc<-read.csv("/home/hanshalbe/Desktop/cmab/data3/OruUCB.csv")

#Matern
maei<-read.csv("/home/hanshalbe/Desktop/cmab/data3/MaternExpectedImp.csv")
mapi<-read.csv("/home/hanshalbe/Desktop/cmab/data3/MaternProbOfImp.csv")
math<-read.csv("/home/hanshalbe/Desktop/cmab/data3/MaternThompon.csv")
mauc<-read.csv("/home/hanshalbe/Desktop/cmab/data3/MaternUCB.csv")

#RBF
rbei<-read.csv("/home/hanshalbe/Desktop/cmab/data3/RBFExpectedImp.csv")
rbpi<-read.csv("/home/hanshalbe/Desktop/cmab/data3/RBFProbOfImp.csv")
rbth<-read.csv("/home/hanshalbe/Desktop/cmab/data3/RBFThompon.csv")
rbuc<-read.csv("/home/hanshalbe/Desktop/cmab/data3/RBFUCB.csv")
...
dfinal<-data.frame(aic=c(bmei$x, bmpi$x, bmth$x, bmuc$x, kfei$x, kfpi$x, kfth$x, kfuc$x, liei, lipi, lith, liuc, ouei$x, oupi$x, outh$x, ouuc$x, maei$x, mapi$x, math$x, mauc$x, rbei$x, rbpi$x, rbth$x, rbuc$x),
                   model=rep(c("Bayesian Mean", "Kalman Filter", "Linear Regression", "Ornstein-Uhlenbeck", "Matérn 3/2", "Radial Basis"), each=48*4),
                   acquisition=rep(rep(c("Expected Improvement", "Probability of Improvement", "Probability of max. Utility", "Upper Confidence Bound"), each=48), 6),
                   id=rep(1:48, 24))


library(MASS)
truehist(dfinal$aic)
dfinal$id[dfinal$aic<100]

dfinal$aic<-ifelse(dfinal$aic>415, 415, dfinal$aic)
dfinal$aic<-ifelse(dfinal$aic<100, 415, dfinal$aic)
dfinal$evidence<- -0.5*dfinal$aic


m<-subset(dfinal, id==1)$evidence
for (i in 2:max(dfinal$id)){
  m<-rbind(m, subset(dfinal, id==i)$evidence) 
}
dim(m)
m<-cbind(m, rep(150*log(0.25),48))
write.csv(m, "/home/hanshalbe/Desktop/cmab/data3/evidence.csv")
...
protected<-read.csv("/home/hanshalbe/Desktop/cmab/data3/protectedbest3.csv", header=FALSE)
...
pdf("/home/hanshalbe/Desktop/cmab/paper/modelcomparison3.pdf", width=10, height=10)
p
dev.off()
...
mnew<-m[indicator,]
dim(mnew)
write.csv(mnew, "/home/hanshalbe/Desktop/cmab/data3/evidencebest3.csv")

protectednew<-as.numeric(read.csv("/home/hanshalbe/Desktop/cmab/data3/protectedbest3.csv", header=FALSE))

#load packages
packages <- c('plyr', 'ggplot2', 'jsonlite', 'MASS', 'gridExtra', 'parallel')
lapply(packages, require, character.only = TRUE)


#Bayesian Mean
bmei<-read.csv("/home/hanshalbe/Desktop/cmab/data/BayesMeanExpectedImp.csv")
bmpi<-read.csv("/home/hanshalbe/Desktop/cmab/data/BayesMeanProbOfImp.csv")
bmth<-read.csv("/home/hanshalbe/Desktop/cmab/data/BayesMeanThompon.csv")
bmuc<-read.csv("/home/hanshalbe/Desktop/cmab/data/BayesMeanUCB.csv")

#Kalman Filter
kfei<-read.csv("/home/hanshalbe/Desktop/cmab/data/KalmanExpectedImp.csv")
kfpi<-read.csv("/home/hanshalbe/Desktop/cmab/data/KalmanProbOfImp.csv")
kfth<-read.csv("/home/hanshalbe/Desktop/cmab/data/KalmanThompon.csv")
kfuc<-read.csv("/home/hanshalbe/Desktop/cmab/data/KalmanUCB.csv")
...
for (folks in 1:46){
    ...
    dat<-read.csv(paste0("/home/hanshalbe/Desktop/cmab/data/lin/p",folks, "lin.csv"))
...
#Ornstein Uhlenbeck
ouei<-read.csv("/home/hanshalbe/Desktop/cmab/data/OruExpectedImp.csv")
oupi<-read.csv("/home/hanshalbe/Desktop/cmab/data/OruProbOfImp.csv")
outh<-read.csv("/home/hanshalbe/Desktop/cmab/data/OruThompon.csv")
ouuc<-read.csv("/home/hanshalbe/Desktop/cmab/data/OruUCB.csv")

#Matern
maei<-read.csv("/home/hanshalbe/Desktop/cmab/data/MaternExpectedImp.csv")
mapi<-read.csv("/home/hanshalbe/Desktop/cmab/data/MaternProbOfImp.csv")
math<-read.csv("/home/hanshalbe/Desktop/cmab/data/MaternThompon.csv")
mauc<-read.csv("/home/hanshalbe/Desktop/cmab/data/MaternUCB.csv")

#RBF
rbei<-read.csv("/home/hanshalbe/Desktop/cmab/data/RBFExpectedImp.csv")
rbpi<-read.csv("/home/hanshalbe/Desktop/cmab/data/RBFProbOfImp.csv")
rbth<-read.csv("/home/hanshalbe/Desktop/cmab/data/RBFThompon.csv")
rbuc<-read.csv("/home/hanshalbe/Desktop/cmab/data/RBFUCB.csv")
...
dfinal<-data.frame(aic=c(bmei$x, bmpi$x, bmth$x, bmuc$x, kfei$x, kfpi$x, kfth$x, kfuc$x, liei, lipi, lith, liuc, ouei$x, oupi$x, outh$x, ouuc$x, maei$x, mapi$x, math$x, mauc$x, rbei$x, rbpi$x, rbth$x, rbuc$x),
                   model=rep(c("Bayesian Mean", "Kalman Filter", "Linear Regression", "Ornstein-Uhlenbeck", "Matérn 3/2", "Radial Basis"), each=47*4),
                   acquisition=rep(rep(c("Expected Improvement", "Probability of Improvement", "Probability of max. Utility", "Upper Confidence Bound"), each=47), 6),
                   id=rep(1:47, 24))
...
write.csv(m, "/home/hanshalbe/Desktop/cmab/data/evidence.csv")
...
protected<-read.csv("/home/hanshalbe/Desktop/cmab/data/protected1.csv", header=FALSE)
...
pdf("/home/hanshalbe/Desktop/cmab/paper/modelcomparison1.pdf", width=10, height=10)
p
dev.off()

mnew<-m[indicator,]
dim(mnew)
write.csv(mnew, "/home/hanshalbe/Desktop/cmab/data/evidencebest.csv")
protectednew<-as.numeric(read.csv("/home/hanshalbe/Desktop/cmab/data/protected1best.csv", header=FALSE))

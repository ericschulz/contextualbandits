...
for (folks in 1:46){
  ...
  for (m in seq_along(models)){
    ...
    dat<-read.csv(paste0("/home/hanshalbe/Dropbox/CMAB/data/raw1/p",folks, "lin.csv"))
...
write.csv(m, "/home/hanshalbe/evidence.csv")
...
protected<-read.csv("/home/hanshalbe/Dropbox/CMAB/data/protected.csv", header=FALSE)
...
pdf("modelcomparison1.pdf", width=10, height=10)
p
dev.off()